...
export interface VaultReadOnlyInterface {
  ...
  getPrice: ({ denom }: { denom: string }) => Promise<PriceInfo>;
  getPrices: () => Promise<ArrayOfPriceInfo>;
  getVaultState: () => Promise<VaultState>;
  getUserShares: ({ user }: { user: string }) => Promise<Uint256>;
...
export class VaultQueryClient implements VaultReadOnlyInterface {
  ...
  listDepositRequests = async ({
    ...
    }) as Promise<ArrayOfDepositRequest>;
  };
  getVaultAssets = async (): Promise<ArrayOfCoin> => {
    return this.client.queryContractSmart(this.contractAddress, {
      get_vault_assets: {},
    }) as Promise<ArrayOfCoin>;
  };
  ...
  getPrice = async ({ denom }: { denom: string }): Promise<PriceInfo> => {
    return this.client.queryContractSmart(this.contractAddress, {
      get_price: {
        denom,
      },
    }) as Promise<PriceInfo>;
  };
  getPrices = async (): Promise<ArrayOfPriceInfo> => {
    return this.client.queryContractSmart(this.contractAddress, {
      get_prices: {},
    }) as Promise<ArrayOfPriceInfo>;
  };
  ...
  getUserShares = async ({ user }: { user: string }): Promise<Uint256> => {
    return this.client.queryContractSmart(this.contractAddress, {
      get_user_shares: {
        user,
      },
