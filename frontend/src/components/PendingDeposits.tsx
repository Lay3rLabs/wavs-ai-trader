...
export function PendingDeposits() {
  ...
  console.log("PendingDeposits component - deposits:", pendingDeposits);
  console.log("PendingDeposits component - isLoading:", isLoading);
  ...
  // Don't hide the section, just show "no pending deposits" message
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-500">
                        From: {deposit.user.slice(0, 20)}...
                        {deposit.user.slice(-10)}
                      </p>
                    </div>
                    <div className="ml-4">
                      <svg
                  ...
                  <div className="mt-4 rounded-lg border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-800 dark:bg-zinc-900">
                    <p className="text-xs text-zinc-600 dark:text-zinc-400">
                      This deposit is waiting for the next price update from
                      WAVS AI agents. Once prices are updated, shares will be
